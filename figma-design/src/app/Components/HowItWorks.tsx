            ...
            return (
              ...
              >
                ...
                <motion.div
                  ...
                  className={`absolute -top-4 right-4 w-12 h-12 rounded-full bg-gradient-to-br ${step.color} flex items-center justify-center text-white font-bold text-sm shadow-lg z-10`}
                >
                  {step.number}
                </motion.div>
