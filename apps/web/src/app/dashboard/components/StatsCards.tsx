...
export default function StatsCards({ stats: initial = { matches: 0, chats: 0, views: 0 } }: { stats?: Stats }) {
  ...
  if (loading) {
    return (
      <section className="flex flex-col md:flex-row gap-8 mb-12 animate-fade-in" aria-label="Summary statistics">
        {[1,2,3].map((i) => (
          <div key={i} className="flex-1 stat-card rounded-2xl bg-gradient-to-br from-purple-100 via-pink-100 to-white shadow p-6 animate-slide-up">
            <div className="w-10 h-10 bg-gradient-to-r from-purple-200 to-pink-200 rounded-full mb-2 animate-pulse" />
            <div className="h-8 w-24 bg-gradient-to-r from-purple-200 to-pink-200 rounded mb-2 animate-pulse" />
  ...
  return (
    <section className="flex flex-col md:flex-row gap-8 mb-12 animate-fade-in" aria-label="Summary statistics">
      <div className="flex-1 stat-card rounded-2xl bg-gradient-to-br from-purple-100 via-pink-100 to-white shadow p-6 animate-slide-up btn" role="region" aria-label="Total matches" tabIndex={0}>
      ...
      <div className="flex-1 stat-card rounded-2xl bg-gradient-to-br from-purple-100 via-pink-100 to-white shadow p-6 animate-slide-up btn" role="region" aria-label="Active chats" tabIndex={0}>
        <span className="text-2xl mb-2" aria-hidden>
          💬
        </span>
        <div className="flex items-end gap-2">
      ...
      <div className="flex-1 stat-card rounded-2xl bg-gradient-to-br from-purple-100 via-pink-100 to-white shadow p-6 animate-slide-up btn" role="region" aria-label="Profile views" tabIndex={0}>
        <span className="text-2xl mb-2" aria-hidden>
          ⭐
        </span>
        <div className="flex items-end gap-2">
